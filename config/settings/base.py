...
API_LIST_CACHE_SECONDS = env_int('API_LIST_CACHE_SECONDS', 20, minimum=0, maximum=300)
API_DETAIL_CACHE_SECONDS = env_int('API_DETAIL_CACHE_SECONDS', 45, minimum=0, maximum=600)
API_CACHE_MAX_PAYLOAD_BYTES = env_int('API_CACHE_MAX_PAYLOAD_BYTES', 500_000, minimum=0, maximum=5_000_000)
...
FINANCE_CONSOLIDATED_CACHE_SECONDS = env_int('FINANCE_CONSOLIDATED_CACHE_SECONDS', 30, minimum=0, maximum=300)
